...
#if defined(USE_CANDLE_MODE) || defined(USE_BIKE_FLASHER_MODE) || defined(USE_PARTY_STROBE_MODE) || defined(USE_TACTICAL_STROBE_MODE) || defined(USE_LIGHTNING_MODE) || defined(USE_FIREWORK_MODE) || defined(USE_LIGHTHOUSE_MODE) || defined(USE_BROKEN_FLUORESCENT_MODE)
